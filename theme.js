...
const ThemeManager = (function () {
  ...
  function applyTheme(theme) {
    ...
    // Keep the browser chrome color (address bar on mobile) matching
    // the site's actual background — this follows our own time/manual
    // theme, not the OS's prefers-color-scheme, since they can differ.
    const meta = document.getElementById("themeColorMeta");
    if (meta) meta.setAttribute("content", theme === "dark" ? "#0D1712" : "#FFFFFF");
  }
